...
const userSql = require(path.resolve( __dirname, "./userdb.js" ) );
...
const controller = {
  getUsers: async function(req,res) {
    ...
    })//.then(()=>{console.log("YEY")}).catch(()=>{console.log("aww")});
  },
  ...
  getProfile: function(req, res) {
    ...
    checkUsername(req.params.userId, function(err, data) {
      ...
      let sql = 'SELECT id, firstname, lastname, email FROM user WHERE id = ?'
